...
class TestMastermind(unittest.TestCase):
    ...
    def test_create_code(self):
        ...
        for i in range (100):
            ...
            if len(code) == 4 and len(code) == len(is_valid_list) and len(code) == len(set(code)): # checks if code is 4 long, valid list is 4 long and there are no duplicates in list
                code_is_valid = True
